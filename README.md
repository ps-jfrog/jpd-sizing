...
- **Storage & network** — block class, premium DB class, object backend, network guidance, load-balancer note (with reverse-proxy config links), K8s notes (CSI driver, LB, ingress).
